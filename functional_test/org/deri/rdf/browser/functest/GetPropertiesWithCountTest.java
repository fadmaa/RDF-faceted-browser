...
public class GetPropertiesWithCountTest {
	...
	public void noFilterNickProperty(){
		...
		String sparql = sparqlEngine.getFacetValuesSparql(mainFilter, facets, nickFacet);
		List<AnnotatedResultItem> res = rdfEngine.getPropertiesWithCount(sparql, endpoint, nickFacet.getVarname());
	...
	public void noFilterMemberProperty(){
		...
		String sparql = sparqlEngine.getFacetValuesSparql(mainFilter, facets, memberFacet);
		List<AnnotatedResultItem> res = rdfEngine.getPropertiesWithCount(sparql, endpoint, memberFacet.getVarname());
